...
async function performAutomationValidation(driver, email, day, month, year, cpf, gender, street, city, postalCode, mobilePhone, password) {
    try {
        ...
        const submitFinishSelector = 'button[data-qa="verification-submit"]';
        const finishButton = await driver.$(submitFinishSelector);
        await driver.waitUntil(async () => {
            return await finishButton.isDisplayed();
        }, {
            timeout: 10000,
...
module.exports = performAutomationValidation;
